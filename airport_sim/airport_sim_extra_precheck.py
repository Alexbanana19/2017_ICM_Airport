...
def main():
    ...
    lanep.addb_checktime = 45 
    lanep.addp_checktime = 30
    
    lanep_extra.id_checktime = 11#9.1895 
    lanep_extra.bag_checktime = 5 #4.862
    lanep_extra.per_checktime = 10 #10.463
    lanep_extra.addb_checktime = 45
    lanep_extra.addp_checktime = 30
    ...
    while True:
        ...
        if next_state == cur_state and counter <= N:
            ...
            if passenger[0].ispre:
                if lanep.getQLen() <= lanep_extra.getQLen():
                    lanep.id_buffer += passenger
                else:
                    lanep_extra.id_buffer += passenger
            else:
                if lane1.getQLen() <= lane2.getQLen():
    ...
    passenger_list = lane1.passenger_list + lane2.passenger_list + lanep.passenger_list + lanep_extra.passenger_list    
    final_time_list = []
